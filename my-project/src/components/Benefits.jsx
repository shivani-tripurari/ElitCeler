...
const Benefits = () => {
  return (
    <div id="benefits" className='container relative z-2 mt-[6.69rem]'>
      ...
      <h2 className={`text-[24px] md:max-w-sm md:text-[32px] lg:max-w-2xl lg:text-[40px] max-w-[50rem] mx-11 mb-12 lg:mb-20`}>Start your journey with <span className='heading-span'>ElitCeler</span></h2>
